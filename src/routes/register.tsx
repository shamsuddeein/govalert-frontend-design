      ...
      <main id="main-content" tabIndex={-1} className="flex-1 flex items-center justify-center px-4 sm:px-6 py-6 sm:py-12 md:py-16 outline-none">
        <div className="w-full max-w-md rounded-[8px] border border-border bg-card p-5 sm:p-8 shadow-sm relative">
          ...
          <button
            ...
            className="w-full h-[44px] inline-flex items-center justify-center gap-2.5 rounded border border-border bg-background text-xs font-semibold text-foreground hover:bg-muted disabled:opacity-50 transition-colors cursor-pointer mb-5 shadow-xs"
          >
