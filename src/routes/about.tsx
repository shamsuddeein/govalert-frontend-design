    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-between selection:bg-secondary/25 font-sans">
      ...
      <main className="flex-1 mx-auto max-w-[1184px] w-full px-6 py-12">
        ...
        <div className="grid gap-8 md:grid-cols-2 mb-16">
          <div className="rounded-[8px] border border-border bg-card p-8 shadow-sm border-l-3 border-l-[#0a5c38] dark:border-l-[#3fb68e] space-y-4">
          ...
          <div className="rounded-[8px] border border-border bg-card p-8 shadow-sm border-l-3 border-l-[#c8960c] space-y-4">
