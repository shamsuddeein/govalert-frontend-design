...
Always inspect the address bar in your browser. If the domain name does not end in \`.nnpcgroup.com\`, it is 100% fake. You can verify any official domain instantly on our [Monitored Portals Directory](/portals).
...
No genuine Nigerian government agency (whether NNPC, Customs, EFCC, or Immigration) requires job applicants to transfer money into a bank account or pay via OPay/PalmPay. Read more on why government jobs never demand payment in our guide: [Why Legitimate Nigerian Government Jobs Never Ask For Payment](/blog/why-legitimate-nigerian-government-jobs-never-ask-for-payment).
...
RecruitmentAlert operates only one verified Telegram notification bot: **@govalerts_bot**. Our bot only sends alerts linking directly to official government portals and never accepts payments or private messages. You can verify our bot anytime on our [Telegram Verification Page](/telegram).
...
\`
  },
  {
    ...
    readTime: "7 min read",
    author: "Shamsuddeen Yusuf",
    category: "Verified Directory",
    content: `
One of the most effective ways to protect yourself from recruitment scams in Nigeria is knowing the exact official portal address for every Federal Ministry, Department, and Agency (MDA).
...
You can inspect live check timestamps and uptime results anytime on our [Monitored Portals Page](/portals) or review real-time check entries on the [Public Audit Log](/audit-log).

---

### How to Stay Protected
- **Never Pay:** Legitimate government recruitment forms are 100% free.
- **Verify URLs:** Always double-check domain endings before entering personal data.
- **Use Bot Verification:** If you receive job alerts via Telegram, verify our bot username **@govalerts_bot** on our [Telegram Verification Page](/telegram).
`
  },
  {
    ...
    content: `
One of the most persistent lies told to Nigerian job seekers is that you must pay for a "scratch card", "processing pin", or "guarantor registration fee" to apply for a federal government job.
...
### 5. What to Do If You Encounter a Paid Job Scam
If you encounter a portal demanding payment for a government job:
1. **Do Not Pay:** Never transfer money or enter your bank credentials.
2. **Verify on RecruitmentAlert:** Search the agency on our [Agencies Directory](/agencies) or [Monitored Portals Page](/portals) to see the official portal URL.
3. **Report the Fraud:** Report the URL to the Independent Corrupt Practices Commission (ICPC) or EFCC.

---

### About RecruitmentAlert
RecruitmentAlert was built by **Shamsuddeen Yusuf**, a software engineering student in Kaduna, Nigeria, to eliminate recruitment scams. Our platform monitors 42 federal portals in real-time and provides 100% free intelligence to job seekers.

Read more about our mission on our [About Page](/about) or verify our official Telegram bot on our [Telegram Verification Page](/telegram).
`
  }
];
